...
import {
  ...
  async function deploy() {
    ...
    const accountContract = new ethers.Contract(newAdminAddress, accountArtifact.abi, currentAdminWallet);
    const accountOwner = await accountContract.owner();
    console.log(`\x1b[36mThis is a Lens Account Owned by: ${accountOwner}\x1b[0m`);
