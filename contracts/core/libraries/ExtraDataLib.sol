...
library ExtraDataLib {
    ...
    function set(mapping(bytes32 => bytes) storage _extraDataStorage, KeyValue[] calldata extraDataToSet)
        internal
        returns (bool[] memory)
    {
    ...
    function _setExtraKeyValue(mapping(bytes32 => bytes) storage _extraDataStorage, KeyValue memory extraKeyValueToSet)
        internal
        returns (bool)
    {
