...
import {KeyValue, RuleChange, RuleProcessingParams} from "./../types/Types.sol";
...
interface IGroup is IMetadataBased {
    ...
    event Lens_Group_MemberAdded(
        address indexed account, uint256 indexed membershipId, KeyValue[] customParams, RuleExecutionData data
    );
