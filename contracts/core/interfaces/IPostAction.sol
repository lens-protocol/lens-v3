...
interface IPostAction {
    event Lens_PostAction_Configured(address indexed feed, uint256 indexed postId, KeyValue[] params);

    event Lens_PostAction_Executed(address indexed feed, uint256 indexed postId, KeyValue[] params);
